...
namespace Analogy.Interfaces.DataTypes
{
    public class AnalogyNotification : IAnalogyNotification
    {
        ...
        public AnalogyNotification(Guid primaryFactoryId, string title, string message, AnalogyLogLevel level, int durationSeconds, Action? actionOnClick) : this(primaryFactoryId, title, message)
        {
            Level = level;
